...
export const EVENTS: EventInfo[] = [
  ...
  {
    id: "techno4all-mar18",
    imageUrl: "/events/techno4all-mar18.jpg",
    title: "Techno 4 All",
    dateLabel: "March 18",
    timeLabel: "10PM – Late",
  ...
  {
    id: "duck-duck-roar-jun4",
    imageUrl: "/events/duck-duck-roar-jun4.webp",
    title: "Duck Duck Roar Presents: Once Upon A Time",
    dateLabel: "June 4 – 7",
    timeLabel: "4 Days",
  ...
  {
    id: "whoa-wed-jan21",
    imageUrl: "/events/whoa-wed-jan21.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring Acacia"],
    accent: "#29e6ff",
    gradient: ["#0a2a1f", "#1a6b4a", "#29e6ff"],
    rotate: -4,
  },
  {
    id: "submerged-apr11",
    imageUrl: "/events/submerged-apr11.webp",
    title: "Same Same Presents: Submerged — Wubs by Wonky Willa",
    dateLabel: "April 11",
    timeLabel: "9PM – Late",
    venue: "Spin Nightclub",
    location: "2028 Hancock St, San Diego, CA",
    ...
    lineup: ["Wonky Willa", "CapoChino", "Shockface", "Cam Steen"],
    tags: ["21+"],
    accent: "#ff2fb0",
    gradient: ["#0a0116", "#3a0a3a", "#ff2fb0"],
    rotate: -3,
  ...
  {
    id: "whoa-wed-apr23",
    imageUrl: "/events/whoa-wed-apr23.webp",
    title: "WHOA Wednesday",
    dateLabel: "April 23",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    lineup: ["DRMDRGN", "Cam Steen", "Wasani"],
    accent: "#ff7a00",
    gradient: ["#2a0a3a", "#7b2ff7", "#ff7a00"],
    rotate: -2,
  },
  {
    id: "beyond-the-rhythm-may2",
    imageUrl: "/events/beyond-the-rhythm-may2.webp",
    title: "Beyond The Rhythm",
    dateLabel: "May 2",
    timeLabel: "4PM – 1AM",
    venue: "Trilogy Sanctuary",
    location: "La Jolla, CA",
    ...
    lineup: ["Wasani Whoa", "Cam Steen", "Von Dyke", "Senzo b2b Seabas", "Daddy Durango"],
    details: ["100% of proceeds support orphaned children in the Congo"],
    tags: ["21+"],
    accent: "#fff229",
    gradient: ["#c97a2f", "#e0a94e", "#fff229"],
    rotate: 2,
  ...
  {
    id: "whoa-wed-may7",
    imageUrl: "/events/whoa-wed-may7.webp",
    title: "WHOA Wednesday",
    dateLabel: "May 7",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
  ...
  {
    id: "whoa-wed-may14",
    imageUrl: "/events/whoa-wed-may14.webp",
    title: "WHOA Wednesday",
    dateLabel: "May 14",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
  ...
  {
    id: "whoa-wed-may28",
    imageUrl: "/events/whoa-wed-may28.webp",
    title: "WHOA Wednesday",
    dateLabel: "May 28",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
  ...
  {
    id: "whoa-wed-jun11",
    imageUrl: "/events/whoa-wed-jun11.webp",
    title: "WHOA Wednesday",
    dateLabel: "June 11",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    details: ["Featuring Gizmo, Wasani, and Friends"],
    accent: "#29ffe6",
    gradient: ["#06121a", "#0c3d4a", "#29ffe6"],
    rotate: -3,
  },
  {
    id: "whoa-wed-jun25",
    imageUrl: "/events/whoa-wed-jun25.webp",
    title: "WHOA Wednesday — Clown Rave",
    dateLabel: "June 25",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    location: "4847 Newport Ave, San Diego",
  ...
  {
    id: "whoa-wed-jul2",
    imageUrl: "/events/whoa-wed-jul2.webp",
    title: "WHOA Wednesday",
    dateLabel: "July 2",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    lineup: ["Anzio (DJ Set)", "Wasani", "Match.A.Mor", "Mystique"],
    accent: "#ff3b3b",
    gradient: ["#1a0505", "#7a1a1a", "#ff3b3b"],
    rotate: 2,
  },
  {
    id: "whoa-wed-jul9",
    imageUrl: "/events/whoa-wed-jul9.webp",
    title: "WHOA Wednesday",
    dateLabel: "July 9",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    details: ["Hosted by Wasani featuring Max Web"],
    accent: "#b6ff29",
    gradient: ["#0a1a05", "#3a6b1a", "#b6ff29"],
    rotate: 3,
  },
  {
    id: "whoa-wed-jul16",
    imageUrl: "/events/whoa-wed-jul16.webp",
    title: "WHOA Wednesday",
    dateLabel: "July 16",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    details: ["Hosted by Wasani featuring Draz"],
    accent: "#29b6ff",
    gradient: ["#05131a", "#0a3a5c", "#29b6ff"],
    rotate: 4,
  },
  {
    id: "whoa-wed-jul23",
    imageUrl: "/events/whoa-wed-jul23.webp",
    title: "WHOA Wednesday",
    dateLabel: "July 23",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
  ...
  {
    id: "whoa-wed-jul30",
    imageUrl: "/events/whoa-wed-jul30.webp",
    title: "WHOA Wednesday",
    dateLabel: "July 30",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    lineup: ["Auxana", "Indigo Valet", "Pineapple Flow", "Wasani"],
    accent: "#c729ff",
    gradient: ["#10021a", "#4a0a5c", "#c729ff"],
    rotate: -3,
  },
  {
    id: "whoa-wed-aug6",
    imageUrl: "/events/whoa-wed-aug6.webp",
    title: "WHOA Wednesday",
    dateLabel: "August 6",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    details: ["Hosted by Wasani featuring Bootydew"],
    accent: "#ffcf29",
    gradient: ["#1a1205", "#6b4a0a", "#ffcf29"],
    rotate: -2,
  },
  {
    id: "air-allinrhythm-aug23",
    imageUrl: "/events/air-allinrhythm-aug23.webp",
    title: "AIR — All In Rhythm",
    dateLabel: "August 23",
    timeLabel: "2PM – 9PM",
    ...
    details: ["Presented by New Life Sounds x Steppin' Til' Checkout"],
    tags: ["21+"],
    accent: "#29e6ff",
    gradient: ["#0a2a1f", "#1a6b4a", "#29e6ff"],
    rotate: 2,
  ...
  {
    id: "whoa-wed-aug20",
    imageUrl: "/events/whoa-wed-aug20.webp",
    title: "WHOA Wednesday",
    dateLabel: "August 20",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    details: ["Hosted by Wasani featuring Burko"],
    accent: "#ff2fb0",
    gradient: ["#0a0116", "#3a0a3a", "#ff2fb0"],
    rotate: 3,
  },
  {
    id: "whoa-wed-aug27",
    imageUrl: "/events/whoa-wed-aug27.webp",
    title: "WHOA Wednesday",
    dateLabel: "August 27",
    timeLabel: "7PM – 11PM",
    venue: "The WHOAdega × SH!FT Gallery",
    ...
    lineup: ["Wasani", "Blue Jade", "Dom Dixon", "Chill Pill"],
    accent: "#ff7a00",
    gradient: ["#2a0a3a", "#7b2ff7", "#ff7a00"],
    rotate: 4,
  },
  {
    id: "primal-party-sep13-2025",
    imageUrl: "/events/primal-party-sep13-2025.webp",
    title: "Primal Party",
    ...
    lineup: ["Alex Shen", "Kaipora", "Wasani Whoa", "Kaali", "Pineapple Flow", "Gypsy Sis", "Match.A.Mor"],
    details: ["Presented by Underware"],
    accent: "#fff229",
    gradient: ["#c97a2f", "#e0a94e", "#fff229"],
    rotate: -4,
  },
  {
    id: "whoa-wed-oct22-2025",
    imageUrl: "/events/whoa-wed-oct22-2025.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring YUL"],
    accent: "#ffb800",
    gradient: ["#1a3a5c", "#c9522f", "#ffb800"],
    rotate: -3,
  },
  {
    id: "whoa-wed-oct29-2025",
    imageUrl: "/events/whoa-wed-oct29-2025.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring Witha"],
    accent: "#baff29",
    gradient: ["#0d3b3b", "#1a8a6b", "#baff29"],
    rotate: -2,
  },
  {
    id: "whoa-wed-nov5-2025",
    imageUrl: "/events/whoa-wed-nov5-2025.webp",
    title: "WHOA Wednesday",
  ...
  {
    id: "submerged-nov8-2025",
    imageUrl: "/events/submerged-nov8-2025.webp",
    title: "Same Same Presents: Submerged — Wubs by Canabliss",
    ...
    lineup: ["Canabliss", "Spirit Motel", "Phunkify"],
    tags: ["21+"],
    accent: "#29ffe6",
    gradient: ["#06121a", "#0c3d4a", "#29ffe6"],
    rotate: 3,
  ...
  {
    id: "whoa-wed-nov12-2025",
    imageUrl: "/events/whoa-wed-nov12-2025.webp",
    title: "WHOA Wednesday",
    ...
    lineup: ["Wasani", "Hunthux", "Noahfence", "Bemm"],
    accent: "#7a5cff",
    gradient: ["#05061a", "#1a1a4a", "#7a5cff"],
    rotate: 4,
  },
  {
    id: "press-pause-nov16-2025",
    imageUrl: "/events/press-pause-nov16-2025.webp",
    title: "Press Pause — Wellness, Healing & Arts",
    ...
    details: ["Presented by Umbrellavation"],
    accent: "#ff3b3b",
    gradient: ["#1a0505", "#7a1a1a", "#ff3b3b"],
    rotate: -4,
  },
  {
    id: "whoa-wed-nov19-2025",
    imageUrl: "/events/whoa-wed-nov19-2025.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring Attenboro"],
    accent: "#b6ff29",
    gradient: ["#0a1a05", "#3a6b1a", "#b6ff29"],
    rotate: -3,
  },
  {
    id: "whoa-wed-dec3-2025",
    imageUrl: "/events/whoa-wed-dec3-2025.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring DrMdrgn"],
    accent: "#29b6ff",
    gradient: ["#05131a", "#0a3a5c", "#29b6ff"],
    rotate: -2,
  },
  {
    id: "whoa-wed-dec10-2025",
    imageUrl: "/events/whoa-wed-dec10-2025.webp",
    title: "WHOA Wednesday — Not Not Down Takeover",
  ...
  {
    id: "whoa-wed-dec17-2025",
    imageUrl: "/events/whoa-wed-dec17-2025.webp",
    title: "WHOA Wednesday",
    ...
    details: ["Hosted by Wasani featuring Rozales D"],
    accent: "#c729ff",
    gradient: ["#10021a", "#4a0a5c", "#c729ff"],
    rotate: 3,
  },
  {
    id: "happy-baby-dec19-2025",
    imageUrl: "/events/happy-baby-dec19-2025.jpg",
    title: "Happy Baby",
    ...
    details: ["DJ set by Britton", "Inspire Visuals"],
    accent: "#ffcf29",
    gradient: ["#1a1205", "#6b4a0a", "#ffcf29"],
    rotate: 4,
  },
  {
    id: "freakuency-nov1-2025",
    imageUrl: "/events/freakuency-nov1-2025.webp",
    title: "Freakuency",
    ...
    details: ["Presented by AUF and Subsessions", "Four stages"],
    accent: "#29e6ff",
    gradient: ["#0a2a1f", "#1a6b4a", "#29e6ff"],
    rotate: -4,
  },
