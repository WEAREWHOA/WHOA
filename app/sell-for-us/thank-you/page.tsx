...
export default function SellForUsThankYouPage() {
  return (
    <section className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <p className="mt-4 text-sm text-muted">
        We&apos;ve got your Sell For Us application. Our team will review it and follow up by
        email — once approved, an EVENT SALES tab unlocks in your portal where you can sign up to
        work upcoming events.
      </p>
      <Link href="/events" className="btn-flame mt-8 rounded-full px-8 py-4 text-base">
        See upcoming events
      </Link>
    </section>
  );
